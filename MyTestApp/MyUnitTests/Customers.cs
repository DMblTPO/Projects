...
namespace MyUnitTests
{
    ...
    static class Data
    {
        public static List<Customer> IniCspCustomers => new List<Customer>
        {
            new Customer
            {
            ...
            new Customer
            {
                ...
                Domains =
                    new List<Domain> {new Domain {Name = "boscust.onmicrosoft.com"}, new Domain {Name = "boscust.net"},}
            },
            new Customer
            {
        ...
        public static List<CustomerDb> IniDbCustomers => new List<CustomerDb>
        {
            new CustomerDb
            {
                TenantId = Guid.Parse("eea26953-1133-4d1b-bdee-c4d61b08c817"),
